...
def get_lrds_maindoc():
    ...
    mongodb_path_lrds = bootstrap.ti_config_service.get_value('get_user_info.mongodb_path_lrds', default='/Users/andpay/PycharmProjects/get_user_info/mongo-lrds')
    mongodb_name_lrds = bootstrap.ti_config_service.get_value('get_user_info.mongodb_name_lrds', default='mongo-lrds')
...
def get_cif_partyadditioninfo():
    ...
    mongodb_path_cif = bootstrap.ti_config_service.get_value('get_user_info.mongodb_path_cif',
                                                         default='/Users/andpay/PycharmProjects/score_card_end/mongo-cif')

    mongodb_name_cif = bootstrap.ti_config_service.get_value('get_user_info.mongodb_name_cif', default='mongo-cif')
...
def get_psns_phonecontact():
    ...
    mongodb_path_psns = bootstrap.ti_config_service.get_value('get_user_info.mongodb_path_psns',
                                                         default='/Users/andpay/PycharmProjects/score_card_end/mongo-psns')

    mongodb_name_psns = bootstrap.ti_config_service.get_value('get_user_info.mongodb_name_psns', default='mongo-psns')
